...
-- Uma ficha pertence à campanha em que nasceu. Mover entre mesas por update
-- contornaria as regras de criação e pode misturar dados de campanhas.
...
-- v19 — personalidade e objetivo privados
